...
define(["../base/OrderedMap", "../base/Log"], function (OrderedMap, Log) {
    ...
    return OrderedMap.clone({
        ...
        addItem : function (id, label, active) {
            if (!label) {
            ...
            Log.trace("Adding item { id:" + this.id + ":" + id + ", label:" + label + ", active:" + active + "}");
            return this.add({ id: id, label: label, active: active });
        },
        ...
        render : function (parent_elmt, render_opts, val, control, css_class, mandatory) {
            var i,
                item,
                select_elmt;
        ...
        renderRadio : function (parent_elmt, render_opts, val, control, css_class, mandatory) {
            var span_elmt,
                i,
                item;
        ...
        renderMulti : function (parent_elmt, render_opts, control, pieces, css_class) {
            var   span_elmt,
                hidden_elmt,
                i,
                item;
        ...
        queryMerge : function (query, lov_column, callback) {
            var count,
                col_val;
        ...
        getCountString : function (include_zeros) {
            var str = "",
                delim = "",
                index;
