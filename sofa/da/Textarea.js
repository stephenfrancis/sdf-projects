...
//---------------------------------------------------------------------------- Textarea
x.fields.Textarea = x.fields.Text.clone({
    id              : "Textarea",
    css_type        : "textarea",
    detokenize      : false,
...
x.fields.Textarea.doc = {
    location                : "x.fields",
    file                    : "$Header: /rsl/rsl_app/core/fields/Textarea.js,v 1.37 2014/08/12 10:55:28 francis Exp $",
...
x.fields.Textarea.set = function (new_val) {
...
x.fields.Textarea.renderEditable = function (div, render_opts, inside_table) {
    var str;
...
x.fields.Textarea.renderUneditable = function (elem, render_opts, inside_table) {
    var style;
...
x.fields.Textarea.getTextFromVal = function () {
...
x.fields.Textarea.detokenizeSpecial = function (str) {
    var out = "",
        i,
        j,
        k,
...
x.fields.Textarea.detokenizeSpecialOne = function (orig_token, split_token) {
    var out,
        row,
        page;
...
x.fields.Textarea.detokenize_image = function (orig_token, split_token) {
...
x.fields.Textarea.detokenize_video = function (orig_token, split_token) {
...
x.fields.Textarea.generateTestValue = function (session) {
    var val;
