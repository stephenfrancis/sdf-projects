...
x.sections.ListUpdate.doc = {
    ...
    properties: {
        ...
        entity              : { label: "Entity object representing the entity, obtained on call to setupEntity(), and used statically", type: "x.Entity", usage: "use methods only" },
...
x.sections.ListUpdate.clone = function (spec) {
    ...
    new_obj = x.sections.ListBase.clone.call(this, spec);
//    new_obj.row_count = 0;
    new_obj.rows_ever = 0;
//    new_obj.rows = [];
    return new_obj;
...
x.sections.ListUpdate.setup = function () {
    ...
    if (!x.entities[this.entity_id]) {
        throw x.Exception.clone({ id: "entity_not_found", entity_id: this.entity_id });
    }
    this.setEntity(this.entity_id, this.owner.page.getDocument());
};

x.sections.ListUpdate.setEntity = function (entity_id, parent_record) {
...
x.sections.ListUpdate.addDeleteColumn = function () {
    var that = this,
        col;
...
x.sections.ListUpdate.addFieldColumn = function (field) {
...
x.sections.ListUpdate.existingRows = function () {
    var that = this;
...
x.sections.ListUpdate.update = function (params) {
    var that = this;
    x.log.functionStart("update", this, arguments);
    x.sections.ListBase.update.call(this, params);
