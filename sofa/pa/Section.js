...
x.sections.Section = x.Base.clone({
    id                      : "Section",
    visible                 : true,
    width                   : "100%",
...
x.sections.Section.presave = function () {
    x.log.functionStart("presave", this, arguments);
};
x.sections.Section.presave.doc = {
...
x.sections.Section.render = function (element, render_opts) {
...
x.sections.Section.getSectionElement = function (render_opts) {
    var temp_title;
...
x.sections.Section.getSectionElement.doc = {
...
x.sections.Section.getCSSClass = function (render_opts) {
    var css_class;
...
x.sections.Section.getCSSClass.doc = {
...
x.sections.Section.isValid = function () {
    return true;
};
x.sections.Section.isValid.doc = {
